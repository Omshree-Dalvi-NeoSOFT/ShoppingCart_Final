                    ...
                    <tbody>
                        @foreach ($category as $cat )
                            <tr>
                                ...
                                <td><a href="editcategory/{{ $cat->id }}" class="btn btn-warning btn-sm" role="button">Edit</a> | <a type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#staticBackdrop" aid="{{$cat->id}}">
                                    Delete</a>
                                <!-- Modal -->
