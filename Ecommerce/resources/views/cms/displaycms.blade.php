                    ...
                    <tbody>
                        @foreach ($cms as $c )
                            <tr>
                                ...
                                <td><a href="editcms/{{ $c->id }}" class="btn btn-warning btn-sm" role="button">Edit</a> | <a type="button" class="btn btn-danger btn-sm dtlban" data-bs-toggle="modal" data-bs-target="#staticBackdrop" aid="{{$c->id}}">
                                    Delete</a>
                                </td>
                            </tr>
                        @endforeach
